...
results/output/robocup/alignments/${model_path}/fold1 15 \
...
results/output/robocup/alignments/${model_path}/fold2 15 \
...
results/output/robocup/alignments/${model_path}/fold3 15 \
...
results/output/robocup/alignments/${model_path}/fold4 15 \
