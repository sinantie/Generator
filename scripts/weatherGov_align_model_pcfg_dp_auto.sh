...
input=data/weatherGov/weatherGovTrainGaborRecordTreebankRightBinarizeGoldRstNormal.gz
output=results/output/weatherGov/alignments/pcfg/rst/model_3_gabor_record_pcfg_treebank_gold_normal_treebank_rst_20iter
