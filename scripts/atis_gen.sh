...
inputLists=datasets/atis/atis-test.txt
numThreads=4
stagedParamsFile=results/atis/alignments/model_3_tagged_CDnumbers/stage1.params.obj.gz
lmFile=datasets/atis/atis-all-train-3-gram-tagged.CDnumbers.model.arpa
lengthPredictionModelFile=datasets/atis/lengthPrediction.counts.linear-reg.model 
...
execDir=results/atis/generation_tagged_CDnumbers/
