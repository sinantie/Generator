 ...
 * @author konstas
 */
public class DMVInferState extends AHypergraphInferState<DepTree, DMVExample, Params>
{
    ...
    public DMVInferState(AModel model, DMVExample ex, Params params,
    ...
    public DMVInferState(AModel model, DMVExample ex, Params params,
                                 Params counts, InferSpec ispec, boolean useHarmonicWeights, Graph graph)
    {
    ...
    protected void createHypergraph(Hypergraph<DepTree> hypergraph)
    {
        ...
        // Need this because not all nodes have parent/children
