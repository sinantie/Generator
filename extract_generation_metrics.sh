# USE in GNU Octave: 
# data = dlmread("file"); 
# wilcoxon_test(data(1,:), data(5,:)) (BLEU-4) 
# wilcoxon_test(data(3,:), data(7,:)) (METEOR)
...
#output=results/output/weatherGov/generation/stat_significance/baseline_vs_lmDmv
...
java -cp dist/Generator.jar induction.utils.postprocess.ExtractGenerationMetrics \
${input1} \
${input2} \
${output}
