...
-inputFileExt events -numThreads $4 -initNoise 0 -indepEventTypes 0,10 -indepFields 0,5 -indepWords 0,5 -newEventTypeFieldPerWord 0,5 \
-newFieldPerWord 0,5 -disallowConsecutiveRepeatFields -dontCrossPunctuation -Options.stage1.smoothing 0 -noneFieldSmoothing 0 \
-outputFullPred -modelUnkWord $5 #-excludedFields flight.stop
