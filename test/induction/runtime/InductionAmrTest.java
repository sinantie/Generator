 ...
 * @author konstas
 */
public class InductionAmrTest
{
    LearnOptions lopts;
    String name;
    GenerativeEvent3Model model;

    public InductionAmrTest() {
    }
    ...
    public void setUp() 
    {
         String args = "-modelType event3 "
                 ...
                 + "-overWriteExecDir "
                 + "-execDir results/output/amr/ldc/alignments/model_3-thres-5_test/ "
                 + "-inputLists "
                 + "../hackathon/data/ldc/split/training/training-thres-5-single.event3 "                 
