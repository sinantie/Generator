 ...
 * @author konstas
 */
public class ServerGenerationAtisTest
{
    LearnOptions lopts;
    String name;
    Event3Model model;
    
    public ServerGenerationAtisTest() {
    }
    ...
    public void setUp() 
    {
         String args = "-modelType generate "
                    ...
                    // discriminative
                    + "-generativeModelParamsFile results/output/atis/alignments/model_3/prior_0.01/stage1.params.obj "
//                    + "-stagedParamsFile results/output/atis/generation/discriminative/"
//                    + "baseline_ignore_ngrams_bigrams_hasCons_oracle_seg5/stage1.discriminative.params.obj.gz "
...
//        model.init(InitType.staged, null, "");   
...
//String example = "{\"flight\":{\"class_type\":\"--\",\"direction\":\"round_trip\",\"from\":\"atlanta\",\"stop\":\"--\",\"to\":\"boston\"},\"search\":[{\"of\":\"flight\",\"typed\":\"max\",\"what\":\"fare\"},{\"of\":\"departure_time\",\"typed\":\"argmin\",\"what\":\"flight\"}]}";
        String example = "{\"flight\":{\"class_type\":\"--\",\"direction\":\"--\",\"from\":\"atlanta\",\"stop\":\"--\",\"to\":\"boston\"},\"search\":[{\"of\":\"--\",\"typed\":\"lambda\",\"what\":\"flight\"}]}";
        String example2 = "{\"flight\":{\"class_type\":\"--\",\"direction\":\"--\",\"from\":\"boston\",\"stop\":\"--\",\"to\":\"baltimore\"},\"search\":[{\"of\":\"--\",\"typed\":\"lambda\",\"what\":\"flight\"}]}";
        String in = model.processExamplesJson(JsonFormat.lowjet, example2, lopts, "lowjet.properties");
        in += model.processExamplesJson(JsonFormat.lowjet, example, lopts, "lowjet.properties");
