...
public class GenerationWinHelpTest
{
    ...
    public void setUp() 
    {
         String args = "-modelType generate "
                    + "-testInputLists data/branavan/winHelpHLA/folds/docs.newAnnotation.removedOutliers/winHelpFold1Eval.tagged "
...
//                    + "model_3_no_null_pos_auto/fold1/stage1.params.obj.gz "
                    + "model_3_docs_no_null_newAnnotation/fold1/stage1.params.obj.gz "
...
//                    + "-binariseAtWordLevel "
                    ...
                    + "-lengthPredictionModelFile data/branavan/winHelpHLA/folds/docs.newAnnotation.removedOutliers/winHelpFold1Train.lengthPrediction.counts.linear-reg.model "
