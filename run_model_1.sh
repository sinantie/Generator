...
-inputFileExt events -numThreads $4 -initNoise 0 -indepEventTypes 0,-1 -indepFields 0,-1 -newEventTypeFieldPerWord 0,-1 -newFieldPerWord 0,-1 \
-disallowConsecutiveRepeatFields -dontCrossPunctuation -Options.stage1.smoothing 0.1 -indepWords 0,-1 -outputFullPred -modelUnkWord -allowNoneEvent $5
