...
#output=results/output/winHelp/generation/generative/no_pos/no_null/model_3_docs_newAnnotation_${kBest}-best_iter${interpolationFactor}_max12_newFolds_gold
output=results/output/winHelp/generation/generative/no_pos/no_null/model_3_docs_newAnnotation_${kBest}-best_iter${interpolationFactor}_max12_newFolds_gold
