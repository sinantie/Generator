...
-inputFileExt events -numThreads $4 -initNoise 0 -indepEventTypes 0,-1 -indepFields 0,-1 -newEventTypeFieldPerWord 0,5 -newFieldPerWord 0,5 \
-disallowConsecutiveRepeatFields -dontCrossPunctuation -Options.stage1.smoothing 0.1 -indepWords 0,5 -outputFullPred -modelUnkWord -allowNoneEvent $5
