...
output=results/output/winHelp/generation/generative/no_pos/no_null/pcfg/rst/model_3_docs_newAnnotation_gold_rst_parent_${kBest}-best_iter${interpolationFactor}_054_gold
#modelPath=results/output/winHelp/alignments/model_3_docs_no_null_newAnnotation_markov1_externalTreebank
modelPath=results/output/winHelp/alignments/model_3_docs_no_null_newAnnotation_gold_rst_parent_externalTreebank
